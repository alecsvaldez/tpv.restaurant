                ...
                <div class="box-body table-responsive"> 
                    <table id="datatable" class="table table-bordered table-striped">
                        ...
                        foreach($data as $d){
                            ...
                            <tr>
                                <td><?php echo $d['id'] ?></td>
                                <td><?php echo $d['nombre'] ?><br><small class="text-muted"><?php echo $d['razon_social']?></small></td>
                                <td><?php echo $d['contacto']?><br><small class="text-primary"><?php echo $d['correo']?></small></td>
