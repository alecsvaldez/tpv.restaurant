                ...
                <div class="box-body table-responsive"> 
                    <table id="datatable" class="table table-bordered table-striped">
                        ...
                        foreach($data as $d){
                            ...
                            <tr>
                                <td><?php echo $d['id'] ?></td>
                                <td><?php echo $d['nombre'] ?><br><small class="text-primary"><?php echo $d['correo']?></small></td>
                                <td>
                                    <i class="fa fa-<?php echo $d['activo'] ? 'check-circle text-success': 'ban text-danger'?>"></i>
                                    <br><small class="text-primary"><?php echo $d['fecha_inicio']?></small>
                                </td>
                                <td><i class="fa fa-phone"></i> <?php echo $d['telefono']?><br><i class="fa fa-mobile"></i> <?php echo $d['celular']?></td>
                                <td></td>
