                ...
                <div class="box-body table-responsive"> 
                    <table id="datatable" class="table table-bordered table-striped">
                        ...
                        foreach($data as $d){
                            ...
                            <tr>
                                <td><?php echo $d['id'] ?></td>
                                <td><?php echo $d['usuario'] ?><br><small class="text-primary"><?php echo $d['nombre']?></small></td>
                                <td><?php echo $roles_indexed[ $d['id_rol']] ?></td>
                                <td><i class="fa fa-2x fa-<?php echo $d['activo'] ? 'check-circle text-success': 'ban text-danger'?>"></i></td>
                                <td><i class="fa fa-phone"></i> <?php echo $d['telefono']?><br><small class="text-primary"><?php echo $d['correo']?></small></td>
                                <td></td>
